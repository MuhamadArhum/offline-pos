...
from app.core.database import orders_col, expenses_col
from app.core.permissions import has_permission
from app.services.table_service import get_all_tables, set_table_status
from app.services.recipe_service import get_recipe
from app.services.inventory_service import restore_stock
from app.services.shift_service import get_all_shifts
from app.utils.print_utils import print_receipt, print_kot
from app.ui.components.pagination import PaginationControl

from app.ui.sales.helpers import (
    IMPROVED_STYLE,
...
class MergeTablesDialog(QDialog):
    def __init__(self, parent=None):
        ...
        layout.addWidget(QLabel("Source Table (to be merged & cleared):"))
        self.combo_source = QComboBox()
        self.combo_source.setFixedHeight(38)
        layout.addWidget(self.combo_source)

        layout.addWidget(QLabel("Target Table (to merge into):"))
...
class ShiftTableDialog(QDialog):
    def __init__(self, parent=None):
        ...
        layout.addWidget(QLabel("Source Table (Running):"))
        self.combo_source = QComboBox()
        self.combo_source.setFixedHeight(38)
        layout.addWidget(self.combo_source)

        layout.addWidget(QLabel("Target Table (Free):"))
        self.combo_target = QComboBox()
        self.combo_target.setFixedHeight(38)
        layout.addWidget(self.combo_target)
