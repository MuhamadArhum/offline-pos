...
from app.services.inventory_service import get_inventory, low_stock_items
from app.services.report_service import generate_purchase_order, get_item_sales_report
from app.core.database import orders_col
from app.ui.shared_ui import C
...
class DashboardPage(QWidget):
    ...
    def _export_dashboard_report(self):
        from app.services.report_service import export_to_csv, today_sales
        path, _ = QFileDialog.getSaveFileName(
