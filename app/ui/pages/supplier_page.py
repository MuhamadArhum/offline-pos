...
from app.services.supplier_service import get_suppliers, add_supplier, update_supplier, delete_supplier
from app.ui.dialogs.supplier_dialog import SupplierDialog
from app.ui.shared_ui import GLOBAL_STYLE, C, make_btn
